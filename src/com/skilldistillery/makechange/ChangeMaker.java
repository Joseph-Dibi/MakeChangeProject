...
public class ChangeMaker {
	...
	private static void moneyTendered(double change) {
		...
		// these amount are then deducted from change if they are able to be divided at
		// least once.
		// larger dollar amounts had to be reset to their value versus the amount before
		// being deducted.
		...
		// coin change is split off dollars for simplicty and readibility, especially in
		// adding larger dollars
		...
		// this is fixed by the addition of .01. successful rounding of change before
		// this may remove that need
	...
	// Run program asks the user for data input on item cost and amount they are
	// paying.
	// if item cost > the cash they give the program will insist that they give the
	// proper amount (You cant walk away without paying! you also can't choose not
	// to buy it, but eh.)
	// if they pay exact change, the program finishes. regardless of it happened on
	// one try or several.
	// if they pay over and need change then the moneyTendered program runs and they
	// receive change.
	private static void runProgram() {
		...
		if (itemCost < 0) {
			System.out.println("It looks like this one is on us.");
		} else {
